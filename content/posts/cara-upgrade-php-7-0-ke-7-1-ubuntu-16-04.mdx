...
thumbnail: '/images/posts/cara-upgrade-php-7-0-ke-7-1-ubuntu-16-04-thumb.webp'
excerpt: 'Assalamualaikum Sobat! kemaren lusa, saya mengalami problem saat mau install project dengan framework Laravel. Usut punya usut, problem yang saya alami dikarenakan versi PHP yang terpasang pada Linux Ubuntu 16.04 saya adalah php versi 7.0.x dan itu tidak memenuhi versi minimum dari Laravel 5.6. Sudah saya coba dengan dengan perintah sudo apt-get dist-upgrade tetapi versinya tetap sama, terus bagaimana caranya?'
readingMinutes: 2
legacyPath: '/2018/04/06/cara-upgrade-php-7-0-ke-7-1-ubuntu-16-04/'
---
![Cara Upgrade PHP 7.0 ke Versi 7.1 di Linux Ubuntu 16.04](/images/posts/cara-upgrade-php-7-0-ke-7-1-ubuntu-16-04-1.webp)
