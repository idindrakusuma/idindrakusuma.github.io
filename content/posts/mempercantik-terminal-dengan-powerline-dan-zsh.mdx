...
category: Tutorial
tags: ['programmer', 'zsh', 'terminal']
thumbnail: '/images/posts/mempercantik-terminal-dengan-powerline-dan-zsh-thumb.webp'
excerpt: 'Jika kamu merupakan pengguna sistem opeasi linux entah apapun distro yang kamu pakai, pasti kamu sudah tidak asing lagi dengan terminal atau bash. Bash di Linux menjadi kebutuhan primer (menurut saya) untuk melakukan berbagai operasi, sebut saja yang paling dasar seperti perintah sudo apt-get update untuk memperbaharui repositori dan sudo apt-get purge untuk menghapus aplikasi / program yang terinstal di sistem.'
readingMinutes: 2
legacyPath: '/2017/06/14/Mempercantik-Terminal-dengan-Powerline-dan-ZSH/'
---
![Mempercantik Terminal dengan Powerline dan ZSH](/images/posts/mempercantik-terminal-dengan-powerline-dan-zsh-1.webp)
...
![ZSH + Powerline di Ubuntu 16.04](/images/posts/mempercantik-terminal-dengan-powerline-dan-zsh-2.webp)
